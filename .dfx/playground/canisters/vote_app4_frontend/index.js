...
import { idlFactory } from './vote_app4_frontend.did.js';
export { idlFactory } from './vote_app4_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VOTE_APP4_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vote_app4_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vote_app4_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vote_app4_frontend.did.js")._SERVICE>}
 */
export const vote_app4_frontend = createActor(canisterId);
